...
public class Chassis extends Subsystem {
	...
	public Chassis() {
		...
		if (Settings.omniWheels) {
			middleMotor = new Victor(RobotMap.MIDDLE_MOTOR);
		...
		if (Settings.useEncoders) {
			// leftEncoder = new Encoder(RobotMap.LEFT_ENCODER_PORT_A,
			// RobotMap.LEFT_ENCODER_PORT_B, false, Encoder.EncodingType.k4X);
			// rightEncoder = new Encoder(RobotMap.RIGHT_ENCODER_PORT_A,
