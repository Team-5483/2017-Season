...
public class OI {
	...
	public OI() {
		JoystickButton l_trigger = new JoystickButton(rightStick,  RobotMap.joystick_trigger);
		JoystickButton l_butt_2 = new JoystickButton( rightStick,  RobotMap.joystick_2);
		JoystickButton l_butt_3 = new JoystickButton( rightStick,  RobotMap.joystick_3);
		JoystickButton l_butt_4 = new JoystickButton( rightStick,  RobotMap.joystick_4);
		JoystickButton l_butt_5 = new JoystickButton( rightStick,  RobotMap.joystick_5);
		JoystickButton l_butt_6 = new JoystickButton( rightStick,  RobotMap.joystick_6);
		JoystickButton l_butt_7 = new JoystickButton( rightStick,  RobotMap.joystick_7);
